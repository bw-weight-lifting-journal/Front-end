...
const Testimonials = (props) => {
  return (
    <Container className="testimonialContainer" fluid>
      ...
      <Media>
        <Media left href="#">
          <img src="https://i.ibb.co/PTC6hQy/jane-headshot.png" alt="Generic placeholder" />
        </Media>
        <Media body>
    ...
    <Media>
        <Media left href="#">
          <img src="https://i.ibb.co/Sw4V7Jk/brian-headshot.png" alt="Generic placeholder" />
        </Media>
        <Media body>
    ...
    <Media>
        <Media left href="#">
          <img src="https://i.ibb.co/ygjw1ps/suze-headshot.png" alt="Generic placeholder" />
        </Media>
        <Media body>
    ...
    <Media>
        <Media left href="#">
          <img src="https://i.ibb.co/5c6dfgj/lee-headshot.png" alt="Generic placeholder" />
        </Media>
        <Media body>
